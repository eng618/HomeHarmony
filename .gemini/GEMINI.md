...
# Home Harmony Gemini Instructions

## Overview

This file provides specific instructions for Gemini to assist in developing the Home Harmony project, a Flutter application designed for family behavior management. The instructions include project structure, coding standards, and guidelines for implementing features and testing.
...
- Be proactive and try to anticipate the user's needs.
- Provide clear and concise explanations of your work.
- Ask for clarification when you are unsure about something.
- Use the available tools to their full potential.
